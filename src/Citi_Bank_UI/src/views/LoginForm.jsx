    ...
    <form onSubmit={formSubmitter} className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          required
          className="w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 bg-white border-slate-300 text-slate-900 focus:bg-blue-50"
        >
