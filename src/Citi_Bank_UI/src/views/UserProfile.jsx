...
const UserProfile = () => {
  const { setlogin1, setUserProfile,mode,setMode } = useStateContext(); // Remove chatbot, setChatbot
  ...
  // Add new menu items for settings/profile management
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: `Switch to ${mode==="dark" ? "light" : "dark"} theme`,
    },
    {
      icon: "🚪",
      label: "Logout",
      ...
      >
        ...
        <div
          className={`p-6 border-b ${
            mode==="dark" ? "border-slate-600/30" : "border-slate-200"
          }`}
        >
